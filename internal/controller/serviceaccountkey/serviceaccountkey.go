...
import (
	...
	"github.com/crossplane/provider-twingate/apis/service/v1alpha1"
	apisv1alpha1 "github.com/crossplane/provider-twingate/apis/v1alpha1"
	"github.com/crossplane/provider-twingate/internal/controller/features"
)

const (
	errNotServiceAccountKey    = "managed resource is not a ServiceAccountKey custom resource"
