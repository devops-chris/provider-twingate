# ====================================================================================
# Setup Project
PROJECT_NAME := provider-twingate
...
XPKGS = provider-twingate
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-twingate: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Twingate CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Twingate controllers
...
# This target prepares repo for your provider by replacing all "twingate"
